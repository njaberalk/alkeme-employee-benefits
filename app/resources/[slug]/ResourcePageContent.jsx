        ...
        <div className="grid md:grid-cols-3 gap-8">
          <div>
            ...
            <div className="space-y-2">
              {['group-health-insurance', 'dental-insurance', 'vision-insurance', 'life-insurance', 'disability-insurance'].map(slug => (
          ...
          <div>
            ...
            <div className="space-y-2">
              {['small-business', 'mid-market', 'large-employers', 'nonprofits', 'professional-services'].map(slug => (
