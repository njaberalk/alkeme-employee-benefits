...
export async function generateMetadata({ params }) {
  ...
  return {
    ...
    alternates: {
      canonical: `https://alkemeins.com/employee-benefits/states/${state.slug}/`,
    },
    openGraph: {
...
export default async function StatePage({ params }) {
  ...
  const jsonLd = [
    {
      ...
      '@type': 'Service',
      name: `Employee Benefits in ${state.name}`,
  ...
  return (
    <>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({ '@context': 'https://schema.org', '@type': 'LocalBusiness', '@id': `https://alkemeins.com/employee-benefits/states/${state.slug}/`, name: 'ALKEME Insurance Services', url: 'https://alkemeins.com', telephone: '+18559255363', email: 'info@alkemeins.com', areaServed: { '@type': 'State', name: state.name }, priceRange: '$$' }) }} />
