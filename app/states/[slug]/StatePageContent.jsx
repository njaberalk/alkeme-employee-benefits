  ...
  return (
    <div ref={ref} className="bg-stone fade-in-view" style={{ padding: '4rem 0' }}>
      <div className="max-w-[68rem] mx-auto px-[60px] max-lg:px-6 max-md:px-4">
        <h2 className="text-brand font-bold leading-[1.3] tracking-tight mb-6" style={{ fontSize: '1.5rem' }}>Employee Benefits in Nearby States</h2>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          <div>
            ...
            <div className="space-y-2">
              {['group-health-insurance', 'dental-insurance', 'life-insurance', 'disability-insurance', 'retirement-plans'].map(slug => (
          ...
          <div>
            ...
            <div className="space-y-2">
              {['small-business', 'mid-market', 'large-employers', 'technology-companies', 'healthcare-employers'].map(slug => (
          ...
          <div>
            ...
            <div className="space-y-2">
              {[
                { slug: 'employee-benefits-cost', label: 'How Much Do Benefits Cost?' },
                { slug: 'aca-compliance-guide', label: 'ACA Compliance Guide' },
                { slug: 'open-enrollment-guide', label: 'Open Enrollment Guide' },
                { slug: 'self-funding-guide', label: 'Self-Funding Guide' },
              ].map(r => (
        ...
        <section className="bg-stone" style={{ padding: '5rem 0' }}>
          <div className="max-w-[900px] mx-auto px-[60px] max-lg:px-6 max-md:px-4">
            <h2 className="text-brand font-bold leading-[1.3] tracking-tight mb-8 text-center" style={{ fontSize: 'clamp(1.8rem, 3vw, 2.2rem)' }}>
              Employee Benefits FAQ — {state.name}
            </h2>
