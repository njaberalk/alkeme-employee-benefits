...
export async function generateMetadata({ params }) {
  ...
  return {
    ...
    alternates: {
      canonical: `https://alkemeins.com/employee-benefits/cities/${city.slug}/`,
    },
    openGraph: {
      title: `${city.metaTitle} | ALKEME Insurance Services`,
      description: city.metaDescription,
      url: `https://alkemeins.com/employee-benefits/cities/${city.slug}/`,
      type: 'website',
    },
  };
}
...
export default async function CityPage({ params }) {
  ...
  const jsonLd = [
    {
      ...
      '@type': 'Service',
      name: `Employee Benefits in ${city.city}, ${city.abbreviation}`,
  ...
  return (
    <>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({ '@context': 'https://schema.org', '@type': 'LocalBusiness', '@id': `https://alkemeins.com/employee-benefits/cities/${city.slug}/`, name: 'ALKEME Insurance Services', url: 'https://alkemeins.com', telephone: '+18559255363', email: 'info@alkemeins.com', areaServed: { '@type': 'City', name: city.city, containedInPlace: { '@type': 'State', name: city.state } }, priceRange: '$$' }) }} />
